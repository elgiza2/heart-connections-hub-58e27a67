...
const DICT: Record<string, Entry> = {
  ...
  chooseNewPasswordTitle: { en: "Choose a new password", "ar-eg": "اختار كلمة سر Newة" },
  ...
  newPasswordMinPlaceholder: { en: "New password (min 8 characters)", "ar-eg": "كلمة سر Newة (8 حروف على الأقل)" },
  ...
  and: { en: " and ", "ar-eg": " و " },
  privacyLink: { en: "Privacy Policy", "ar-eg": "Privacy policy" },
  ...
  rowIntegrations: { en: "Integrations", "ar-eg": "الربط بالApps" },
  ...
  mobileIntroSub: { en: "Chat, images, video, slides, code and deep research — in one place.", "ar-eg": "شات، صور، فيديو، شرايح، كود وDeep research — كله في مكان واحد." },
...
const UI_DICT: Record<string, Entry> = {
  ...
  newChat: { en: "New chat", "ar-eg": "شات New" },
  newProject: { en: "New project", "ar-eg": "مشروع New" },
  ...
  placeholderAllInOne: { en: "Design, write, research — all in one place", "ar-eg": "صمّم واكتب واSearch — كله في مكان واحد" },
  ...
  openTools: { en: "Open attachments and tools", "ar-eg": "افتح المرفقات وTools" },
  ...
  imageModels: { en: "Image models", "ar-eg": "موديلات Images" },
  ...
  readyWhenYouAre: { en: "Ready when you are", "ar-eg": "Ready when you are" },
